...
export default {
  ...
  JWT_SECRET: process.env.JWT_SECRET ||  'WAI111MHMUNICIPIO222YUMU333SECRET444KEY555',
  PREFIX_URL: process.env.PREFIX_URL || '/api',
  API_MAPASTER: process.env.API_MAPASTER || 'https://api-geo.lomasdezamora.gov.ar/buscar_direccion',
